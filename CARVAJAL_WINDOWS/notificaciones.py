...
# Configuración del correo (usar variables de entorno si están disponibles)
CORREO_REMITENTE = os.getenv('CORREO_REMITENTE', "notificacion@dismelltda.com")
PASSWORD_CORREO = os.getenv('PASSWORD_CORREO', "muaebnciwfmoelgl")
CORREO_DESTINATARIO = os.getenv('CORREO_DESTINATARIO', "soporte@dismelltda.com")
